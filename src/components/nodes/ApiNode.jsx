  ...
  return (
    ...
    >
      <CardHeader className="node-header relative cursor-pointer" onClick={toggleExpand}>
        <CardTitle className="text-pink-foreground font-bold flex items-center justify-between text-xs">
      ...
      {isExpanded && (
        <CardContent className="node-content">
          {isEditing ? (
            ...
            <p className="mb-2 text-xs"><strong>API Config:</strong> {editedData.config}</p>
          )}
        </CardContent>
      )}
